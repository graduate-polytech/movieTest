		...
		$(document)
				.ready(
						function() {
							...
							$('.table tbody tr').click(
									function() {
										...
										modal.find('#userid').val(
												rowData.eq(0).text());
										modal.find('#userpw').val(
												rowData.eq(1).text());
										modal.find('#username').val(
												rowData.eq(2).text());
										modal.find('#birthday').val(
												rowData.eq(3).text());
										modal.find('#email').val(
												rowData.eq(4).text());
										modal.find('#userAddress').val(
												rowData.eq(5).text());
										modal.find('#Genre_1').val(
												rowData.eq(6).text());
										modal.find('#Genre_2').val(
												rowData.eq(7).text());
										modal.find('#Genre_3').val(
												rowData.eq(8).text());
										modal.find('#Genre_4').val(
												rowData.eq(9).text());
										modal.modal('show');
							...
							var button = document
									.getElementById('addressSerchBtn')
								...
								new daum.Postcode(
										{
											oncomplete : function(data) {
												...
												document
														.getElementById("userAddress").value = data.roadAddress;
											}
										}).open();
							}
						});
