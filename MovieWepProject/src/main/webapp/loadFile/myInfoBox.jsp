			...
			Genre_4
			 -->
				...
				<div class="rowMargin ">
					...
					<label>이메일</label>
					<br>
					<div class="genres input-group">
							<input id="userEmail_1"  type="text" class="form-control" placeholder="Username" aria-label="Username" required>
							<span class="input-group-text">@</span>
							<input id="userEmail_2" type="text" class="form-control" list="email-domain" placeholder="email 선택" aria-label="email 선택" required>
					</div>
				</div>
				<div class="rowMargin">
					<!-- 생일 birthDay -->
				...
				<div class="rowMargin">
					...
					<div>
						...
						<input type="text" id="userAddress" name="userAddress" placeholder="도로명주소"
							disabled="disabled" style="width: 100%" required
						>
				...
				<div class="rowMargin">
					...
					<br>
					<input type="text" id="Genre_1" name="Genre_1" list="genre" placeholder="선로 장르 선택"
						style="width: 49%"
					>
					<input type="text" id="Genre_2" name="Genre_2" list="genre" placeholder="선로 장르 선택"
						style="width: 49%"
					>
					<input type="text" id="Genre_3" name="Genre_3" list="genre" placeholder="선로 장르 선택"
						style="width: 49%"
					>
					<input type="text" id="Genre_4" name="Genre_4" list="genre" placeholder="선로 장르 선택"
						style="width: 49%"
					>
				</div>
