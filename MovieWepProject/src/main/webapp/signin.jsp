		...
		<div class="login-box shadowBox">
			...
			<div id="form-floating mb-3" style="margin-top: 20px auto;">
				<form id="signinForm" name="signinForm" method="post" action="main.jsp"
					style="margin: 40px auto; width: 60%;" onsubmit="return trySignIn()"
				>
					...
					<input type="password" class="form-control" id="userPw" name="userPw" placeholder="Password"
						style="height: 40px; font-size: 20px; padding: 5px;"
					>
					<input id="login-btn" type="submit" class="btn btn-outline-primary"
						style="margin: 30px; margin-bottom: 5px; height: 50px; width: 60%; margin: 5px;" value="로그인"
					>
					<a href="signup.jsp"
						style="text-align: end; width: 80%; display: flex; flex-direction: row-reverse;"
					>회원가입</a>
				</form>
			</div>
		</div>
