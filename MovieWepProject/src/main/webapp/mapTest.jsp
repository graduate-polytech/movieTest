...
<body>
    ...
    <script>
        // Google Maps API 키
        const apiKey = 'AIzaSyCFWttU33_ZQvbz5cU1vdkdtcyPL2Tr53U'; // 여기에 본인의 API 키를 넣으세요
     ...
     // 검색 함수 정의
        ...
        function initMap() {
            ...
            navigator.geolocation.getCurrentPosition((position) => {
                ...
                DB.CinemaDataAccess cinemaDataAccess = new DB.CinemaDataAccess();
                List<DB.Cinema> cinemaList = cinemaDataAccess.getAllCinemaData();
                for (DB.Cinema cinema : cinemaList) { %>
                    // 주소를 좌표로 변환
